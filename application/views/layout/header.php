...
<body class="hold-transition sidebar-mini layout-fixed pl-auto">
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=site_url('mudik/get_dashboard')?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?=site_url('mudik/get_transportasi')?>" class="nav-link">
            ...
            <li class="nav-item">
            <a href="<?=site_url('mudik/get_penumpang')?>" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Verifikasi Tiket Penumpang
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?=site_url('mudik/logout')?>" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Logout
              </p>
