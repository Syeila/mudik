      ...
      <div class="container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#booking">Booking tiket</a></li>
...
<!-- End Contact Us Section -->
      ...
      <section id="daftar" class="faq">
        <div class="container">
          ...
          <center>
         <form action="<?php echo site_url('/user/daftar'); ?>" method="POST" class="register-form" id="login-form" data-aos="fade-up" data-aos-delay="400">
             <input type="hidden" value="" name="id"/> 
            <div class="form-group">
                  <label for="nama"><i class="zmdi zmdi-account material-icons-name"></i>Nama: </label>
                    <input class="ml-5" type="text" name="nama" id="nama" placeholder="Name"/>
              </div>
              <div class="form-group">
                    <label for="your_email"><i class="zmdi zmdi-account material-icons-name"></i>Email: </label>
                    <input class="ml-5" type="text" name="email" id="email" placeholder="Email"/>
              </div>
              <div class="form-group">
                    <label for="Username"><i class="zmdi zmdi-account material-icons-name"></i>Username: </label>
                    <input class="ml-2" type="text" name="username" id="email" placeholder="Username"/>
              </div>
              <div class="form-group">
                    <label for="your_pass"><i class="zmdi zmdi-lock"></i>Password: </label>
                    <input class="ml-2" type="password" name="password" id="your_pass" placeholder="Password"/>
              </div>
      ...
      <!-- ======= Login ======= -->
        ...
        <center>
         <form action="<?php echo site_url('/user/aksi_login'); ?>" method="POST" class="register-form" id="login-form" data-aos="fade-up" data-aos-delay="400">
              <div class="form-group">
                    <label for="your_email"><i class="zmdi zmdi-account material-icons-name"></i>Username: </label>
